...
//                 <div key={index} className='mb-8 flex flex-wrap lg:justify-center relative'>
...
//                         <div className='mt-4 flex flex-wrap p-4 lg:absolute lg:bottom lg:right-20 hover:scale-110 duration-300'>
//                             <FaGithub className='text-3xl text-stone-300 mr-2'/>
